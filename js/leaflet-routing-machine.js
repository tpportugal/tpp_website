  ...
  module.exports = L.Class.extend({
    ...
    _setResults: function(results) {
      ...
      for (i = 0; i < results.length; i++) {
        if (results[i].type === 'administrative') {
        ...
        icon = this.options.showResultIcons && results[i].icon ? L.DomUtil.create('img', '', td) : null,
        text = results[i].html ? undefined : document.createTextNode(results[i].name);
        //td.appendChild(text);
        ...
        L.DomEvent.addListener(td, 'click', this._createClickListener(results[i]));
                ...
                if (results[i].html) {
                    td.innerHTML = td.innerHTML + results[i].html;
                } else {
                    td.appendChild(text);
                }
      }
...
(function() {
  ...
  module.exports = L.Class.extend({
    ...
    createStep: function(text, depart_instr, arrive_instr, distance, icon, steps) {
...
(function() {
  ...
  module.exports = L.extend(Localization, {
    ...
    'pt': {
      ...
      ui: {
        startPlaceholder: 'Introduz o local de Partida',
        viaPlaceholder: 'Via {viaNumber}',
        endPlaceholder: 'Introduz o local de Chegada'
      }
    },
    'sk': {
      directions: {

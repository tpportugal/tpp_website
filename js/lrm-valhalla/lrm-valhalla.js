...
(function() {
  ...
  module.exports = L.Class.extend({
        ...
        if (!timedOut) {
          if (!err) {
            ...
            console.log("Error : " + err.response);
              alert("Erro - Rota não encontrada: " + err.response);
              callback.call(context || callback, {
              status: err.status,
    ...
    // lrm valhalla is trying to unify manuver of subroutes,
...
(function() {
  ...
  module.exports = L.Class.extend({
    ...
    // to see more options https://valhalla.com/documentation/mobility/turn-by-turn/api-reference/#locations
